...
import { AlertCircle, Calendar, ClipboardList, FilePenLine, HeartPulse, Info, Smile, Stethoscope, Trash2 } from 'lucide-react';
      ...
      <CardHeader className="flex flex-row justify-between items-start">
        <div>
          ...
          <CardDescription className="flex items-center gap-4 mt-2">
            ...
            <span className="flex items-center gap-2"><AlertCircle size={14} /> {patient.chiefComplaint}</span>
          </CardDescription>
        </div>
      ...
      <CardContent>
        <Tabs defaultValue="profile">
          ...
          <TabsContent value="profile" className="pt-6 space-y-6">
             ...
             <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><ClipboardList size={20} /> Treatment Plans</CardTitle>
                </CardHeader>
                <CardContent>
                    <p className="text-sm text-muted-foreground whitespace-pre-wrap">{patient.treatmentPlans}</p>
                </CardContent>
             </Card>
             <Card>
                <CardHeader>
